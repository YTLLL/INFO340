...
5. [challenge5](./challenge5/README)
...
git remote add upstream https://github.com/info340c-au19/challenges.git
```
...
When a new assignment has been posted, you must run the following command to update your repo with the starter code for that week's challenge.
